...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Comprobar si ya existe una instancia de Chart
    if (window.myChart) {
        window.myChart.destroy(); // Elimina el gráfico anterior si existe
    }

    // Crear una nueva instancia de Chart solo una vez
    window.myChart = new Chart(ctx, {
        type: "radar",
        data: {
            labels: [
            ...
            datasets: [
                {
                    ...
                    pointHoverRadius: 8,
                    pointHoverBorderWidth: 3,
                    pointShadowColor: "rgba(255, 215, 0, 0.7)",
                    pointShadowBlur: 10,
                },
            ],
        },
